...
public class AparapiCanvas implements DrawingCanvas {
    ...
    private PixelBufferFloat pixelBuffer = new PixelBufferFloat();
    ...
    public static BufferedImage pixelsToImage(float[] pixels, int width, int height) {
    ...
    private static byte fromColor(float color) {
